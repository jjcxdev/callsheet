      ...
      <div className="flex h-full items-center justify-center">
        <div
          ...
          style={{
            ...
            width:
              "min(calc(100vw - 2rem), calc((100vh - 2rem) * 0.7727272727272727))",
            height:
              "min(calc(100vh - 2rem), calc((100vw - 2rem) / 0.7727272727272727))",
            maxWidth: "100%",
            maxHeight: "100%",
            padding: "0.35in",
          }}
                    ...
                    <div className="flex h-fit w-full whitespace-nowrap bg-white font-extralight normal-case text-black">
                      ...
                      <div className="w-full flex-col">
                        ...
                        <div
                          ...
                          } truncate whitespace-nowrap border-b border-black px-1 text-left`}
                        >
